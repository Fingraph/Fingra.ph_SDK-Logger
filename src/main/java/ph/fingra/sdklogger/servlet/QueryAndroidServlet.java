...
import ph.fingra.sdklogger.util.LoggerHelperAndroid;
import ph.fingra.sdklogger.util.QueryErrorCode;

public class QueryAndroidServlet extends HttpServlet {	
    
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(QueryAndroidServlet.class);
    
    private JsonLoggerRunnable jsonLoggerRunnable;
    private Thread thread;
    
    public QueryAndroidServlet() {
        super();
    }
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        jsonLoggerRunnable = new JsonLoggerRunnable(LoggerHelperAndroid.class);
